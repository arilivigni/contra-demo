...
deployOpenShiftTemplate(docker_repo_url: '172.30.1.1:5000', openshift_namespace: 'contra-sample-project',
                        jenkins_slave_image: 'jenkins-contra-sample-project-slave', containersWithProps: containers,
                        podName: podName) {
